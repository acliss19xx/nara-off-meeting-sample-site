    ...
    foreach ($pages as $page):
        ...
        <div class="row">
            <div class="col-xs-2">
                <?php
                    $labelcolor = array();
                    $labelcolor['guardian'] = "blue";
                    $labelcolor['student'] = "brown";
                    $labelcolor['teacher'] = "green";
                ?>
                <span class="label" style="background-color:<?php echo $labelcolor[$page->getPageTypeHandle()] ?>">
                    <?php echo $page->getPageTypeName(); ?>
                </span>
            </div>
            <div class="col-xs-3">
